...
if (TARGET GTest::gmock)
  ...
  FIND_LIBRARY(LIBGMOCK_MAIN_LIBRARY_DEBUG NAMES gmock_maind PATHS ${LIBGMOCK_INCLUDE_DIR}/../lib)
  FIND_LIBRARY(LIBGMOCK_MAIN_LIBRARY_RELEASE NAMES gmock_main PATHS ${LIBGMOCK_INCLUDE_DIR}/../lib)
  FIND_LIBRARY(LIBGMOCK_LIBRARY_DEBUG NAMES gmockd PATHS ${LIBGMOCK_INCLUDE_DIR}/../lib)
  FIND_LIBRARY(LIBGMOCK_LIBRARY_RELEASE NAMES gmock PATHS ${LIBGMOCK_INCLUDE_DIR}/../lib)
  FIND_LIBRARY(LIBGTEST_LIBRARY_DEBUG NAMES gtestd PATHS ${LIBGMOCK_INCLUDE_DIR}/../lib)
  FIND_LIBRARY(LIBGTEST_LIBRARY_RELEASE NAMES gtest PATHS ${LIBGMOCK_INCLUDE_DIR}/../lib)
